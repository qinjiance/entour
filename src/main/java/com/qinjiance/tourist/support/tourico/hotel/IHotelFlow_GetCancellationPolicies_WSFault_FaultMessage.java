/**
 * IHotelFlow_GetCancellationPolicies_WSFault_FaultMessage.java
 *
...
public class IHotelFlow_GetCancellationPolicies_WSFault_FaultMessage extends java.lang.Exception {
    private static final long serialVersionUID = 1448296970653L;
    private com.qinjiance.tourist.support.tourico.hotel.HotelFlowStub.WSFaultE faultMessage;

    public IHotelFlow_GetCancellationPolicies_WSFault_FaultMessage() {
        super("IHotelFlow_GetCancellationPolicies_WSFault_FaultMessage");
    }
