/**
 * ICarService_BookCar_CustomCarExceptionFault_FaultMessage.java
 *
...
public class ICarService_BookCar_CustomCarExceptionFault_FaultMessage extends java.lang.Exception {
    private static final long serialVersionUID = 1449409321311L;
    private com.qinjiance.tourist.support.tourico.car.CarWebServiceStub.CarWebServiceExceptionE faultMessage;

    public ICarService_BookCar_CustomCarExceptionFault_FaultMessage() {
        super("ICarService_BookCar_CustomCarExceptionFault_FaultMessage");
    }
